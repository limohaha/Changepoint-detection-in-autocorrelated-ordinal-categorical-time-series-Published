...
source("Tools/myfuncPaper.R")
sourceCpp("Tools/myfuncPaper.cpp")
...
# & C2 & C3 & C4 & C5 & C6 & beta0 & beta1 & beta2 & phi \\ 
# \hline
# True & 1.2000 & 2.2000 & 3.1000 & 4.1000 & 5.3000 & 2.9000 & -0.6000 & 9.0000 & 0.5000 \\ 
# Mean & 1.2054 & 2.2076 & 3.1135 & 4.1189 & 5.3249 & 2.9189 & -0.6020 & 9.0544 & 0.4998 \\ 
# Rel.bias & -0.0045 & -0.0035 & -0.0044 & -0.0046 & -0.0047 & -0.0065 & -0.0033 & -0.0060 & 0.0003 \\ 
# sd & 0.0750 & 0.0964 & 0.1146 & 0.1366 & 0.1724 & 0.1110 & 0.0386 & 0.3361 & 0.0146 \\ 
# \hline
# \end{tabular}
# \end{table}
...
# & C2 & C3 & C4 & C5 & C6 & beta0 & beta1 & beta2 & phi \\ 
# \hline
# True & 1.200 & 2.200 & 3.100 & 4.100 & 5.300 & 2.900 & -0.600 & 9.000 & 0.500 \\ 
# Mean & 1.205 & 2.208 & 3.114 & 4.119 & 5.325 & 2.919 & -0.602 & 9.054 & 0.500 \\ 
# Rel.bias & -0.005 & -0.003 & -0.004 & -0.005 & -0.005 & -0.007 & -0.003 & -0.006 & 0.000 \\ 
# sd & 0.075 & 0.096 & 0.115 & 0.137 & 0.172 & 0.111 & 0.039 & 0.336 & 0.015 \\ 
# \hline
# \end{tabular}
# \end{table}
...
# & C2 & C3 & C4 & C5 & C6 & beta0 & beta1 & beta2 & phi \\ 
# \hline
# True & 1.200 & 2.200 & 3.100 & 4.100 & 5.300 & 2.900 & -0.600 & 9.000 & -0.600 \\ 
# Mean & 1.205 & 2.207 & 3.117 & 4.123 & 5.338 & 2.924 & -0.600 & 9.072 & -0.600 \\
# Rel.bias & -0.004 & -0.003 & -0.005 & -0.006 & -0.007 & -0.008 & -0.001 & -0.008 & 0.000 \\
# sd & 0.063 & 0.095 & 0.122 & 0.160 & 0.215 & 0.136 & 0.043 & 0.365 & 0.014 \\
# \hline
# \end{tabular}
# \end{table}
